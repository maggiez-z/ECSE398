...
// option to use GPIO6 as chip select
// vishy: when using ext osc GPIO19 is ext osc input: enable GPIO6 and comment out GPIO19 use above
// also in lmp91400_spi.c use GPIO6

//    GpioCtrlRegs.GPAPUD.bit.GPIO6 = 0;   // Enable pullup on GPIO
//    GpioDataRegs.GPADAT.bit.GPIO6 = 1;   // Disable Lmp91400 chip select
