...
//	SciaRegs.SCILBAUD    =0x009D;  // 9600 baud @LSPCLK = 12MHz (48 MHz SYSCLK)
//	SciaRegs.SCILBAUD    =0x00B6;  // 9600 baud @LSPCLK = 14MHz (56 MHz SYSCLK)
    SciaRegs.SCILBAUD    =0x00C2;  // 9600 baud @LSPCLK = 15MHz (60 MHz SYSCLK)
//    SciaRegs.SCILBAUD    =0x0062;    // 19200 baud @LSPCLK = 15MHz (60 MHz SYSCLK)
