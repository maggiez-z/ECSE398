...
// Configure GPIO34 (GPIO8 on GPA for Matt's board) as a GPIO output pin
   EALLOW;
...
{
   CpuTimer0.InterruptCount++;
   GpioDataRegs.GPATOGGLE.bit.GPIO8 = 1; // Toggle GPIO34 (GPIO8 on GPA) once per 500 milliseconds
